...
export function BlogCard({ post }: BlogCardProps) {
  ...
  return (
    <Card className="group h-full w-full overflow-hidden border-border bg-transparent p-0 shadow-none">
      <CardHeader className="p-0">
        <Link href={`/blog/${slug}`} className="relative block aspect-[2.1/1] overflow-hidden rounded-md">
