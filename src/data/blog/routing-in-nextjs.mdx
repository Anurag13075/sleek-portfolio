...
### Creating a Custom Page (e.g., Anurag Page)

If you want a page accessible at:

_http://localhost:3000/Anurag_

Follow the same steps as above:

1. Inside _src/app_, create a folder named _Anurag_.
2. Inside _Anurag_, create a _page.tsx_ file.
3. Add the following code:

```tsx
export default function Anurag() {
  return <h1>Hello from Anurag</h1>;
}
```
